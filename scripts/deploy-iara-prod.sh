#!/bin/bash
#
# Deploy IAra to Production Environment
#
# Usage:
#   ./scripts/deploy-iara-prod.sh           # Full deploy
#   ./scripts/deploy-iara-prod.sh --dry-run # Show commands without executing
#   ./scripts/deploy-iara-prod.sh --skip-tests # Skip test execution
#
...
for arg in "$@"; do
  case $arg in
    ...
    --skip-tests)
      ...
      ;;
    --help|-h)
      echo "Deploy IAra to Production Environment"
      echo ""
...
echo -e "${BLUE}"
echo "╔════════════════════════════════════════╗"
echo "║     IAra - Deploy to Production        ║"
echo "╚════════════════════════════════════════╝"
echo -e "${NC}"
